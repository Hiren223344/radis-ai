    ...
    <section className="w-full max-w-7xl mx-auto px-6 py-16 md:py-24">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="relative mt-4 flex flex-col items-center justify-center p-8 bg-white rounded-xl border border-[#E2E8F0] shadow-sm h-[200px] overflow-hidden group hover:border-[#5F6FFF] transition-colors duration-200">
            <div className="w-full max-w-[200px] space-y-4">
              ...
              <div className="flex gap-2 justify-center pt-2">
                ...
                <div className="flex items-center justify-center size-8 rounded-md border border-[#E2E8F0] bg-white cursor-pointer hover:bg-[#F8FAFC] transition-colors">
                  <Image src="https://t0.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://google.com/&size=256" alt="Google" width={16} height={16} className="size-4" />
                </div>
                <div className="flex items-center justify-center size-8 rounded-md border border-[#E2E8F0] bg-white cursor-pointer hover:bg-[#F8FAFC] transition-colors">
                  <Image src="https://t0.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://github.com/&size=256" alt="Github" width={16} height={16} className="size-4" />
                </div>
                <div className="flex items-center justify-center size-8 rounded-md border border-[#E2E8F0] bg-white cursor-pointer hover:bg-[#F8FAFC] transition-colors">
                  <Image src="https://t0.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://discord.com/&size=256" alt="Discord" width={16} height={16} className="size-4" />
                </div>
                <div className="flex items-center justify-center size-8 rounded-md border border-[#E2E8F0] bg-white cursor-pointer hover:bg-[#F8FAFC] transition-colors">
