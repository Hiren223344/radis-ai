...
const models = [
  {
    name: 'Molmo2-8B',
    author: 'Ai2',
    authorUrl: 'https://openrouter.ai/models?author=allenai',
  ...
  },
  {
    name: 'Seedream 4.5',
    author: 'byte-dance',
    authorUrl: 'https://openrouter.ai/models?author=bytedance',
  ...
  },
  {
    name: 'MiniMax-M2.1',
    author: 'minimax',
    authorUrl: 'https://openrouter.ai/models?author=minimax',
  ...
  },
  {
    name: 'GLM-4.7',
    author: 'z-ai',
    authorUrl: 'https://openrouter.ai/models?author=z-ai',
  ...
  },
  {
    ...
    author: 'google',
    authorUrl: 'https://openrouter.ai/models?author=google',
  ...
  },
  {
    ...
    author: 'mistralai',
    authorUrl: 'https://openrouter.ai/models?author=mistralai',
  ...
  },
  {
    ...
    authorUrl: 'https://openrouter.ai/models?author=black-forest-labs',
